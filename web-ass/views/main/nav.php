  ...
  <?php
    if (!isset($_SESSION["guest"])) {
      ...
      echo '
        ...
        <a href="index.php?page=main&controller=contact&action=index" class="nav-item nav-link text-dark" >Contact Us</a>
        <a href="index.php?page=main&controller=edit&action=index" class="nav-item nav-link text-dark" >Edit Profile</a>
        <a href="index.php?page=main&controller=login&action=index" class="nav-item nav-link text-dark" >Logout</a>
      ';
    }
  ?>
</div>
